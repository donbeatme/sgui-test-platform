...
def poll_weixin_account(account_id: int):
    # The scheduler only needs the task registration, not the agent/knowledge stack.
    from .services import (
        build_headers, build_timeout, create_base_info, ensure_trailing_slash,
        extract_weixin_numeric_field, extract_weixin_payload_error,
        extract_text_from_items, generate_reply, get_or_create_conversation,
        persist_message, send_text_message, WEIXIN_SESSION_EXPIRED_ERRCODE,
