<template>
  <div class="skill-manager">
      ...
      <div v-else class="skill-list">
        ...
        >
          <div class="skill-header">
            <div class="skill-name">{{ platformSkillLabel(skill.name) }}</div>
            <a-switch
          ...
          <div class="skill-description">{{ platformSkillDescription(skill.name, skill.description) }}</div>
    ...
    <a-modal
      ...
      :title="platformSkillLabel(currentSkillContent?.name || text.skillContent)"
      :width="700"
      :footer="false"
    >
      <div v-if="currentSkillContent" class="skill-content-view">
        <div class="content-description">{{ platformSkillDescription(currentSkillContent.name, currentSkillContent.description) }}</div>
        <a-divider />
...
import { zipNameSuggestsInternalSkill, platformSkillLabel, platformSkillDescription } from '../utils/internalSkills'
