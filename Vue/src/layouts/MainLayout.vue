<template>
  <a-layout class="main-layout guicase-layout">
    <!-- 顶部导航栏 -->
    <a-layout-header class="header">
      ...
      <div class="user-info">
        ...
        <span class="version-badge">{{ locale === 'en-US' ? 'SGUI Local' : 'SGUI 本地版' }}</span>
    ...
    <a-layout class="inner-layout">
      ...
      >
        ...
        >
          ...
          <a-menu-item key="workbench" v-if="hasTestcasesPermission">
            <template #icon><icon-apps /></template>
            <a href="#" @click="checkProjectAndNavigate($event, '/workbench')">图文用例工作台</a>
          </a-menu-item>
...
import { platformIcon, platformName } from '@/utils/platform';
