...
const APP_MESSAGES: MessageCatalog = {
  ...
  'chat.empty': {
    'zh-CN': '开始与 SGUI 的对话吧',
    'en-US': 'Start a conversation with SGUI',
  },
  'chat.releaseToUpload': {
    'zh-CN': '释放以上传图片',
...
const LEGACY_EXACT_EN_MAP: Record<string, string> = {
  ...
  '支持上传图片自动转换为Base64，也支持粘贴图片URL或Base64；留空则自动回退至默认 SGUI 图标。': 'Upload an image to convert it to Base64, or paste an image URL/Base64. Leave blank to use the default SGUI icon.',
  ...
  '如：SGUI': 'e.g. SGUI',
  '如：SGUI自动化测试平台': 'e.g. SGUI Automation Testing',
  ...
  '支持完整的图片 URL 地址，或直接贴入 Base64 编码的图标，留空则自动回退至默认 SGUI 图标。': 'Supports image URL or Base64. Leave blank to use the default logo.',
  'SGUI自动化测试平台': 'SGUI Automation Testing',
  ...
  '微信接入': 'WeChat access',
  '清除对话': 'Clear chat',
  '开始与 SGUI 的对话吧': 'Start a conversation with SGUI',
  ...
  '请双击项目目录中的 Start-Fusion.cmd，启动本机执行器。': 'Run Start-Fusion.cmd in the project folder to start the local actuator.',
